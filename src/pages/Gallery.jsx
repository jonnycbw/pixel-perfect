...
const GalleryPage = () => {
    const images = [
        {
            ...
            thumbnail: "https://www.theboltonnews.co.uk/resources/images/13280089?type=responsive-gallery-fullscreen",
            thumbnailWidth: 320,
            thumbnailHeight: 174,
            isSelected: false,
...

        {
            ...
            thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9gxZ5byrrPtI396isJTAzVfoUUxG8fmmQOQ&usqp=CAU",
            thumbnailWidth: 320,
            thumbnailHeight: 212,
        },

        {
            ...
            thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxl4kFNYzxKzoNnIZ5xzQ5yYSr1Ehvx6_qEQ&usqp=CAU",
            thumbnailWidth: 320,
            thumbnailHeight: 212,
        },
        {
            src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsJro0pgroOjQ5tR3MP4gph9rUvpRHg-OxdQ&usqp=CAU",
            thumbnail: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsJro0pgroOjQ5tR3MP4gph9rUvpRHg-OxdQ&usqp=CAU",
            thumbnailWidth: 320,
            thumbnailHeight: 212,
        },
    ];
    ...
    return (
        <div style={{ minHeight: "75vh", marginTop: "90px", padding: "50px 100px" }}>
            <h1 style={{ color: "#D866EB" }}>GALLERY</h1>
            Here you will find some of our most recent work, these photos are taken from our social media pages
            <br />
            <br />
            <br />
            <Gallery style={{ maxHeight: "50px", margintop: 50 }} images={images} />
        </div>
    );
};
